...
import { NOTIFICATION_PATH, RESULTS_PATH, STATISTICS_PATH, PROFILE_PATH, EDIT_PATH, USERS_PATH } from './profile-routing.constants';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: USERS_PATH, component: QuestionsEditComponent, canActivate: [AuthGuard] },
    ],
