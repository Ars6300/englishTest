...
export const initialState: QuestionsState = {
  ...
  {
      "id": "3",
      "answers": ["had arrived, would have missed", "would arrive, would miss", "would have arrived, would have missed", "arrived, would have missed"],
...
export function questionListReducer(state: QuestionsState,
  action: Action) {
